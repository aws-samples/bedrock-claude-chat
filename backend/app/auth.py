...
def verify_token(token: str) -> dict:
    ...
    # FYI : https://github.com/mpdavis/python-jose/blob/4b0701b46a8d00988afcc5168c2b3a1fd60d15d8/jose/jwt.py#L59
    # The access_token is not included in the front-end request header, so at_hash is ignored.
