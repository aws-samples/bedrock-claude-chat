  ...
  translation: {
    ...
    model: {
      ...
      'qwen3-32b': {
        label: 'Qwen3 32B',
        description:
          'Modelo denso de 32B parámetros con ventana de contexto de 32K, salida máxima de 8K y modos de pensamiento híbridos para respuestas rápidas y razonamiento profundo.',
      },
    },
    agent: {
      label: 'Agente',
